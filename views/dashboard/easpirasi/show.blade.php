...
<div class="row justify-content-center p-5">
  <div class="col">
    <h2 class="text-center mb-1 text-uppercase">
    ...
    <div class="mt-3">
      <a href="/dashboard-easpirasi" class="btn btn-warning"><span data-feather="arrow-left"></span> Kembali</a>
      <form action="/dashboard-easpirasi/{{ $aspirasi->nik }}" method="POST" class="d-inline">
        @csrf

        <button class="btn btn-success" onclick="return confirm('Apakah Aspirasi telah selesai diproses?')"><span data-feather="x-circle"></span> Aspirasi Selesai</button>
      </form>
    </div>
