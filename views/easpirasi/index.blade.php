                        ...
                        <div class="accordion" id="accordionPanelsStayOpenExample">
                            <div class="accordion-item">
                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <p>Untuk menyampaikan aspirasi anda diminta untuk menggunakan identitas anda, yakni
                                            NIK (Nomor Induk Kependudukan) & NAMA sesuai KTP yang diisi di kolom yang
                                            tersedia.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p>Pada kolom aspirasi harap menggunakan bahasa indonesia, dengan singkat dan jelas
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        <strong>3. Setiap aspirasi yang anda sampaikan angkan di tindak lanjuti maksimal 14
                                            hari kerja</strong>
                                    </button>
                                </h2>
                                <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p>Setiap aspirasi yang masuk akan ditampung oleh admin dan Anda dapat selalu
                                            memeriksa status aspirasi Anda pada halaman <a href="/easpirasi-cek">cek
                                                aspirasi.</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="panelsStayOpen-headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        <strong>4. Terimakasih telah menggunakan layanan ini dengan bijak & sesuai ketentuan
                                            yang ada</strong>
                                    </button>
                                </h2>
                                ...
                                <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p>Silakan lengkapi data pada form isian data aplikasi E-Aspirasi dibawah.
                                            Setelah semua informasi sudah terisi lengkap akhiri dengan klik tombol Kirim
                                            Aspirasi, Aspirasi Anda akan tersimpan pada panel Admin.</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <form method="POST" action="/easpirasi" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik"
                                name="nik" required autofocus value="{{ old('nik') }}" placeholder="16 digit">
                            @error('nik')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                name="nama" required autofocus value="{{ old('nama') }}" placeholder="Sesuai KTP">
                            @error('nama')
                                <div class="invalid-feedback text-start">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('ktp') is-invalid @enderror" type="file" id="ktp"
                                name="ktp" onchange="previewImage()">
                            @error('ktp')
                                <div class="invalid-feedback text-start">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                id="alamat" name="alamat" required autofocus value="{{ old('alamat') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kontak') is-invalid @enderror"
                                id="kontak" name="kontak" required autofocus value="{{ old('kontak') }}">
                            @error('kontak')
                                <div class="invalid-feedback text-start">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <img class="img-preview img-fluid mb-3 col-sm-4" style="width: 350px">
                            <input class="form-control @error('pendukung') is-invalid @enderror" type="file"
                                id="pendukung" name="pendukung" onchange="previewImage()">
                            @error('pendukung')
                                <div class="invalid-feedback text-start">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-secondary mb-5 mt-3">K I R I M &nbsp; A S P I R A S I
