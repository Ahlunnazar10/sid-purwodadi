...
<div class="container">
  <section class="jumbotron text-center mb-5 mt-3">
      <div id="konten">
          <h1 class="text-center">Badan Permusyawaratan Desa Purwodadi</h1>
          <p class="text-center mb-1" style="font-size: 13px"><i class="bi bi-bookmarks-fill"></i> : PERMENDAGRI NOMOR 110 TENTANG BADAN PERMUSYAWARATAN DESA</p>
          <hr>

          <p class="mt-4">Secara yuridis, tugas Badan Permusyawaratan Desa mengacu kepada regulasi desa yakni Undang-Undang Nomor 6 Tahun 2014 tentang Desa. </p>
          ...
          <ol>
            ...
            <li>Menyelenggarakan musyawarah Desa khusus untuk pemilihan Kepala Desa antarwaktu.
            </li>
            <li>Membahas dan menyepakati rancangan Peraturan Desa bersama Kepala Desa.</li>
            <li>Membahas dan menyepakati Rancangan Peraturan Desa bersama Kepala Desa.</li>
