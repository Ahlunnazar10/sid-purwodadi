...
@section('container')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2" style="color: #055160">Tambahkan data potensi pertanian sawah disini :</h1>
    </div>
    ...
    <div class="container">
      <div class="row pt-4 pb-4 ">
        ...
        <div class="col-lg-8" id="form-input">
            <form method="POST" action="/dashboard-pertanian-create" enctype="multipart/form-data">
            @csrf
                <div class="mb-3">
