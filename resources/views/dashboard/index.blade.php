  ...
  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 mt-3" id="card">
    ...
    <div class="col me-auto mb-5">
      <div class="card mb-3 shadow-sm" style="border-radius:15px">
        <div class="row g-0">
          <div class="col-md-6" id="img-dashboard">
            <img src="/img/settings.png" class="img-fluid rounded-start mt-2 p-4" alt="...">
          </div>
          <div class="col-md-6">
            <div class="card-body">
              <h4 class="card-title mt-3" style="font-weight: 500">Verify User :</h4>
              <p class="card-text fs-4">{{ $users->count('id') }} Pending</p>
              <p><a class="btn btn-outline-secondary" href="/dashboard-manajemen-user">Lihat detail &raquo;</a></p>
            </div>
          </div>
        </div>
      </div>
